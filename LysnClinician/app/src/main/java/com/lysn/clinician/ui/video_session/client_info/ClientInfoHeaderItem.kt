...
class ClientInfoHeaderItem(@StringRes private val titleStringResId: Int) : Item(titleStringResId.toLong()) {

    override fun getLayout()= R.layout.item_client_info_header
